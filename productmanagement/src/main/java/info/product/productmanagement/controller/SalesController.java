...
public class SalesController {
	...
	public String saveSales(@Valid @ModelAttribute( "salesDisplay")SalesDisplayModel salesDisplay , BindingResult bindingResult)
	{
		...
		salesService.saveSalesLogic( salesDisplay.getQuantity(), productService.getProductById(salesDisplay.getProductId()), customerService.getCustomerById(salesDisplay.getCustomerId()));
	...
	public String salesIndex(Model model)
	{
		...
		for(SalesModel sale: listOfSales)
		{
			...
			salesIndexModel.setCustomerName(sale.getCustomer().getFName());
			salesIndexModel.setProductName(sale.getProduct().getProductName());
